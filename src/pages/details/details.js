        ...
        <div className="page">
            ...
            <div className="page-details">
                ...
                <div className="details-iamage">
                    ...
                    <div className="details-iamage-inf">Picture «{information.name}»</div>
                </div>
                <div className="details-information">
                    <div className="details-information-item">
                        <div className="details-information-title">Species:</div>
                        <div className="details-information-text">{information.species}</div>
                    </div>
                    <div className="details-information-item">
                        <div className="details-information-title">Status:</div>
                        <div className="details-information-text">{information.status}</div>
                    </div>
                    <div className="details-information-item">
                        <div className="details-information-title">Gender:</div>
                        <div className="details-information-text">{information.gender}</div>
                    </div>
                        ...
                        {information.episode ? (
                            information.episode.map((episode) => (
                                <div className="details-information-item-episode">
                                  <Link to={episode ? episode.replace("https://rickandmortyapi.com/api", "") : ""}>{`Episode ${episode.replace("https://rickandmortyapi.com/api/episode/", "")}`}</Link>
                                </div>
                            ))
                        ) : (
                            <div className="details-information-text">No episodes available</div>
                        )}
                        </div>
                    </div>
                </div>
            ...
            <div className="page-details">
                ...
                <div className="details-information">
                    <div className="details-information-item">
                        ...
                        <div className="details-information-text">{information.type}</div>
                    </div>
                    <div className="details-information-item">
                        <div className="details-information-title">Dimension:</div>
                        <div className="details-information-text">{information.dimension}</div>
                    </div>
                    ...
                    <div className="details-information-title">Residents:</div>
                        ...
                        {information.residents ? (
                            information.residents.map((residents) => (
                                <div className="details-information-item-episode">
                                     <Link to={residents ? residents.replace("https://rickandmortyapi.com/api", "") : ""}>{`Character ${residents.replace("https://rickandmortyapi.com/api/character/", "")}`}</Link>
                                </div>
                            ))
                        ) : (
                            <div className="details-information-text">No episodes available</div>
            ...
            <div className="page-details">
                ...
                <div className="details-information">
                    ...
                    <div className="details-information-item">
                        ...
                        <div className="details-information-text">{information.air_date}</div>
                    </div>
                    <div className="details-information-item">
                        <div className="details-information-title">Episode</div>
                        <div className="details-information-text">{information.episode}</div>
                    </div>
                    <div className="details-information-item">
                    ...
                    <div className="details-information-title">Characters:</div>
                        ...
                        {information.characters ? (
                            information.characters.map((characters) => (
                                <div className="details-information-item-episode">
                                    <Link to={characters ? characters.replace("https://rickandmortyapi.com/api", "") : ""}>{`Character ${characters.replace("https://rickandmortyapi.com/api/character/", "")}`}</Link>
                                </div>
                            ))
                        ) : (
                            <div className="details-information-text">No episodes available</div>
